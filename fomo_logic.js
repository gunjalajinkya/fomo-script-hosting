...
<head>
    ...
    <title>Penshift Fomo Notification Widget</title>
    <!-- Basic styling for the widget to ensure it looks good and is responsive -->
    <style>
        body {
        ...
        /* The main Fomo notification container style */
        .fomo-widget-style {
            position: fixed;
            bottom: 20px;
            right: 20px;
            left: 20px; /* Make it responsive on mobile */
            max-width: 360px;
            margin: 0 auto;
        ...
        .fomo-icon {
            ...
            margin-right: 12px;
            border-radius: 50%;
            background: linear-gradient(45deg, #FF6F61, #E53935); /* Gradient for a premium look */
            display: flex;
            align-items: center;
...
<body>
    ...
    <div id="sales-fomo-notification" aria-live="polite" class="fomo-widget-style">
        <div class="fomo-icon">
            <!-- SVG Icon representing a purchase/activity (e.g., shopping bag/cart) -->
    ...
    <script>
        ...
        // NOTE: All products are now set to "Screen-to-Pencil Shift Bundle" and price to 197, as requested.
        const DUMMY_SALES_DATA = [
            {"name":"Pooja Sharma","location":"Pune","price":197,"product":"Screen-to-Pencil Shift Bundle"},
            {"name":"Siddharth More","location":"Mumbai","price":197,"product":"Screen-to-Pencil Shift Bundle"},
            {"name":"Aisha Khan","location":"Nagpur","price":197,"product":"Screen-to-Pencil Shift Bundle"},
            {"name":"Ganesh Patil","location":"Nashik","price":197,"product":"Screen-to-Pencil Shift Bundle"},
            {"name":"Renuka Joshi","location":"Thane","price":197,"product":"Screen-to-Pencil Shift Bundle"},
            {"name":"Farah Sheikh","location":"Aurangabad","price":197,"product":"Screen-to-Pencil Shift Bundle"},
            {"name":"Vivek Deshmukh","location":"Kolhapur","price":197,"product":"Screen-to-Pencil Shift Bundle"},
            {"name":"Deepali Kulkarni","location":"Pune","price":197,"product":"Screen-to-Pencil Shift Bundle"},
            {"name":"Zainab Inamdar","location":"Mumbai","price":197,"product":"Screen-to-Pencil Shift Bundle"},
            {"name":"Rajesh Soni","location":"Latur","price":197,"product":"Screen-to-Pencil Shift Bundle"},
            {"name":"Karan Verma","location":"New Delhi","price":197,"product":"Screen-to-Pencil Shift Bundle"},
            {"name":"Neha Khanna","location":"Gurgaon, HR","price":197,"product":"Screen-to-Pencil Shift Bundle"},
            {"name":"Amit Singh","location":"Noida, UP","price":197,"product":"Screen-to-Pencil Shift Bundle"},
            {"name":"Priya Malik","location":"Faridabad, HR","price":197,"product":"Screen-to-Pencil Shift Bundle"},
            {"name":"Mohit Jain","location":"Ghaziabad, UP","price":197,"product":"Screen-to-Pencil Shift Bundle"},
            {"name":"Shefali Gupta","location":"New Delhi","price":197,"product":"Screen-to-Pencil Shift Bundle"},
            {"name":"Rajat Sharma","location":"Gurgaon, HR","price":197,"product":"Screen-to-Pencil Shift Bundle"},
            {"name":"Ayesha Bibi","location":"Noida, UP","price":197,"product":"Screen-to-Pencil Shift Bundle"},
            {"name":"Varun Yadav","location":"New Delhi","price":197,"product":"Screen-to-Pencil Shift Bundle"},
            {"name":"Simran Kaur","location":"Ghaziabad, UP","price":197,"product":"Screen-to-Pencil Shift Bundle"},
            {"name":"Nitin Hegde","location":"Bengaluru, KA","price":197,"product":"Screen-to-Pencil Shift Bundle"},
            {"name":"Deepa Rao","location":"Mysuru, KA","price":197,"product":"Screen-to-Pencil Shift Bundle"},
            {"name":"Arjun Reddy","location":"Bengaluru, KA","price":197,"product":"Screen-to-Pencil Shift Bundle"},
            {"name":"Lakshmi Iyer","location":"Mangaluru, KA","price":197,"product":"Screen-to-Pencil Shift Bundle"},
            {"name":"Syed Hussain","location":"Hubli, KA","price":197,"product":"Screen-to-Pencil Shift Bundle"},
            {"name":"Meena Kumar","location":"Bengaluru, KA","price":197,"product":"Screen-to-Pencil Shift Bundle"},
            {"name":"Vishal Gowda","location":"Shivamogga, KA","price":197,"product":"Screen-to-Pencil Shift Bundle"},
            {"name":"Anjali Menon","location":"Bengaluru, KA","price":197,"product":"Screen-to-Pencil Shift Bundle"},
            {"name":"Ramesh Bhat","location":"Belagavi, KA","price":197,"product":"Screen-to-Pencil Shift Bundle"},
            {"name":"Hema Latha","location":"Bengaluru, KA","price":197,"product":"Screen-to-Pencil Shift Bundle"},
            {"name":"Srinivasan P.","location":"Chennai, TN","price":197,"product":"Screen-to-Pencil Shift Bundle"},
            {"name":"Priya Mani","location":"Coimbatore, TN","price":197,"product":"Screen-to-Pencil Shift Bundle"},
            {"name":"Abdul Qadir","location":"Madurai, TN","price":197,"product":"Screen-to-Pencil Shift Bundle"},
            {"name":"Janani Devi","location":"Tiruchirappalli, TN","price":197,"product":"Screen-to-Pencil Shift Bundle"},
            {"name":"Ravi Shankar","location":"Salem, TN","price":197,"product":"Screen-to-Pencil Shift Bundle"},
            {"name":"Shalini Babu","location":"Chennai, TN","price":197,"product":"Screen-to-Pencil Shift Bundle"},
            {"name":"Gopal Iyengar","location":"Vellore, TN","price":197,"product":"Screen-to-Pencil Shift Bundle"},
            {"name":"Mary Joseph","location":"Dindigul, TN","price":197,"product":"Screen-to-Pencil Shift Bundle"},
            {"name":"Harish S.","location":"Chennai, TN","price":197,"product":"Screen-to-Pencil Shift Bundle"},
            {"name":"Ayesha Begum","location":"Erode, TN","price":197,"product":"Screen-to-Pencil Shift Bundle"},
            {"name":"Ayan Mukherjee","location":"Kolkata, WB","price":197,"product":"Screen-to-Pencil Shift Bundle"},
            {"name":"Shruti Das","location":"Howrah, WB","price":197,"product":"Screen-to-Pencil Shift Bundle"},
            {"name":"Raja Ghosh","location":"Durgapur, WB","price":197,"product":"Screen-to-Pencil Shift Bundle"},
        ...
        function hideNotification() {
            ...
            setTimeout(showNotification, intervalDelay - 600); // 600ms is roughly the transition time
        }
